...
Este proyecto busca automatizar la clasificación de basura en **6 categorías** (cartón, vidrio, metal, papel, plástico y basura general) utilizando técnicas de Visión por Computador y Deep Learning. Para ello, se utiliza el dataset público **TrashNet** disponible en Kaggle. Las métricas que se evaluarán para medir el desempeño del modelo serán Accuracy, Precision, Recall y F1 Score.
